import type { ApiResponse, DashboardJSON, KPI, RecommendedChart, BusinessInsight, DatasetMetadata } from "@pulsebi/shared-types";
...
export async function askQuestion(
  datasetId: string,
  question: string
): Promise<{ answer: string; intent: unknown; data: Record<string, unknown>[] }> {
  return request(`/ask/${datasetId}/ask`, {
    method: "POST",
...
export async function getSummary(
  datasetId: string
): Promise<{ greeting: string; summary: string; highlights: string[]; followUpQuestions: string[] }> {
