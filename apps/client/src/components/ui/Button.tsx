...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = "primary", size = "md", loading, className, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      ...
      secondary: "bg-surface-100 text-surface-700 hover:bg-surface-200 active:bg-surface-300 focus:ring-surface-300",
      ghost: "text-surface-600 hover:bg-surface-100 active:bg-surface-200 focus:ring-surface-300",
